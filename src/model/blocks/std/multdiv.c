...
void std_multdiv_generate_init(FILE * f, block_t * block){
}
...
int blocks_add_std_multdiv(const char * name, int * pin, int pin_n, int * min, int min_n, int out, model_t * model){
    ...
    int b = model_add_block(ps, pin_n + min_n, pout, 1, params, 0, name, 
        "std/multdiv", 0, std_multdiv_generate, std_multdiv_generate_init, model
    );
